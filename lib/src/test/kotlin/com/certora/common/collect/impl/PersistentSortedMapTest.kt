...
class PersistentSortedMapTest: MapTest() {
    ...
    override fun makeMap(): MutableMap<HashTestObject?, Any?> = treapMapOf<HashTestObject, Any?>().builder().uncheckedAs<MutableMap<HashTestObject?, Any?>>()
    ...
    override fun makeMapOfInts(): TreapMap<Int?, Int?> = treapMapOf<Int, Int?>().uncheckedAs<TreapMap<Int?, Int?>>()

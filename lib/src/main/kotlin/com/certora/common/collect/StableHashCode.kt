...
/**
    ...
    1) Our PersistentMap/PersistentSet implementations rely on the keys' hash codes to balance the underlying Treap data
       structures.  When these are deserialized, we need the resulting objects' hash codes to be the same as they were
       when serialized.
